...
<head>
  ...
  <title>LuxRent | Rent a Car</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <!-- Place for logo-->
      <span class="brand-text font-weight-light">LuxRent</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ url('/admin/vehicles/all') }}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{ url('/admin/users/all') }}" class="nav-link">
